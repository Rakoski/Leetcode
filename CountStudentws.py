...
# sandwich in the stack (i = 0 is the top of the stack) and students[j]
# is the preference of the ith student in the initial queue (j = 0 is the front of the queue).
